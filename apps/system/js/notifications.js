...
var NotificationScreen = {
    ...
    swipe: function ns_swipe(evt) {
        ...
        // - left to right
        // - far or fast enough
        if ((distance > 0) || !(farEnough || fastEnough)) {
    ...
    addNotification: function ns_addNotification(detail) {
        ...
        if (typeof(ScreenManager) !== 'undefined' && !ScreenManager.screenEnabled) {
...
SettingsListener.observe('wallpaper.colors', '', function(value) {
    NotificationScreen.colors = value;
    console.log('-----' + value);
});